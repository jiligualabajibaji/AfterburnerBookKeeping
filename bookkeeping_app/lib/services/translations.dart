...
class AppTranslations {
  ...
  static const _strings = <String, Map<String, String>>{
    ...
    'home.return_current_month': {'zh': '回到本月', 'en': 'This month'},
    ...
    'home.invert_month': {'zh': '反选本月', 'en': 'Invert this month'},
    'home.selected_expense_count': {'zh': '当前已选择{n}条支出明细', 'en': '{n} expense transactions selected'},
    'home.selected_income_count': {'zh': '当前已选择{n}条收入明细', 'en': '{n} income transactions selected'},
    'home.selected_prefix': {'zh': '当前已选择', 'en': 'Selected '},
    'home.selected_expense_mid': {'zh': '{n}条支出', 'en': '{n} expense'},
    'home.selected_income_mid': {'zh': '{n}条收入', 'en': '{n} income'},
    'home.selected_suffix': {'zh': '明细', 'en': ' transactions'},
    ...
    'add.save_return': {'zh': '存&回', 'en': 'Save'},
    ...
    'add.category_hint_collapsed': {'zh': '...分类为折叠的分类', 'en': '... contains collapsed categories'},
    ...
    'add.collapse_category': {'zh': '放入折叠', 'en': 'Move to collapsed'},
    'add.expand_category': {'zh': '移出折叠', 'en': 'Remove from collapsed'},
    ...
    'add.quantity_settings': {'zh': '数量 / 单位设置', 'en': 'Quantity / Unit settings'},
    'add.step_interval': {'zh': '步长（每次变化间隔）', 'en': 'Step interval'},
    'add.unit_step': {'zh': '步长：{value}', 'en': 'Step: {value}'},
    'add.unit_step_title': {'zh': '设置“{unit}”的步长', 'en': 'Set step for “{unit}”'},
    'add.default_unit': {'zh': '默认单位', 'en': 'Default unit'},
    'add.default_quantity': {'zh': '默认数量', 'en': 'Default quantity'},
    'add.unit': {'zh': '单位', 'en': 'Unit'},
    'add.unit_hint_longpress': {'zh': '长按此处进入默认个数和单位的设置', 'en': 'Long press to set default quantity and units'},
    'add.units': {'zh': '单位列表（拖拽调整顺序）', 'en': 'Units (drag to reorder)'},
    'add.new_unit': {'zh': '新单位', 'en': 'New unit'},
    'add.delete_category_title': {'zh': '删除分类', 'en': 'Delete category'},
    'add.delete_category_body': {'zh': '删除“{name}”前，请选择该分类下全部记录要移动到的分类。', 'en': 'Before deleting “{name}”, choose where all of its records should be moved.'},
    'add.move_records_to': {'zh': '记录移动到', 'en': 'Move records to'},
    'add.prepend_note': {'zh': '添加到原备注前（可选）', 'en': 'Add before existing note (optional)'},
    'add.prepend_note_hint': {'zh': '新备注与原备注之间会自动加空格', 'en': 'A space will be added before the existing note'},
    'add.confirm_delete': {'zh': '删除', 'en': 'Delete'},
    'add.confirm_delete_category_title': {'zh': '确认删除分类', 'en': 'Confirm category deletion'},
    'add.confirm_delete_category_name': {'zh': '待删除分类：{name}', 'en': 'Category to delete: {name}'},
    'add.confirm_delete_category_count': {'zh': '分类下的明细：{n}条', 'en': 'Transactions in category: {n}'},
    'add.confirm_delete_category_target': {'zh': '记录移动到：{name}', 'en': 'Move records to: {name}'},
    'add.confirm_delete_category_note': {'zh': '新增备注：{note}', 'en': 'New note: {note}'},
    'add.confirm_delete_category_no_note': {'zh': '无', 'en': 'None'},
    'add.confirm_delete_category_warning': {'zh': '确认后将迁移记录并删除该分类。', 'en': 'Confirm to move the records and delete this category.'},
    ...
    'search.jump': {'zh': '跳转', 'en': 'Jump'},
    'search.jump_hint': {'zh': '点击跳转可跳转到流水中具体条目；点击其他部位可以进入编辑界面', 'en': 'Tap Jump to locate the transaction; tap elsewhere to edit.'},
    ...
    'settings.show_ledger_integer_decimals': {'zh': '是否展示.0和.00', 'en': 'Show .0 and .00'},
    'settings.show_ledger_integer_decimals_hint': {'zh': '流水页面金额统一显示两位小数', 'en': 'Show all ledger amounts with two decimal places'},
